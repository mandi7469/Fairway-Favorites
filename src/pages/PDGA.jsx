  ...
  return (
    <div className="pdga-container">
      ...
      <div className="iframe-wrapper">
        ...
        >
          Your browser does not support iframes. Please visit <a href="https://udisc.com/" target="_blank" rel="noopener noreferrer">the UDisc website</a> directly.
        </iframe>
      </div>
      <p className="link">
      ...
      <p className="note">
        Note: This search is embedded directly from the UDisc website. Functionality
